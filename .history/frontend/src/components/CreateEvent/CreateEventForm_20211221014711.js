...
function CreateEventForm () {
  ...
  const handleSubmit = (e) => {
    ...
    const types_options = [
    { value: "1", label: Class</option>
    { value: "2", label: Competition</option>
    { value: "3", label: Congress</option>
    { value: "4", label: Dance Cruise</option>
    { value: "5", label: Flash Mob</option>
    { value: "6", label: Marathon</option>
    { value: "7", label: Nightclub Event</option>
    { value: "8", label: Retreat</option>
    { value: "9", label: Social</option>
    { value: "10, label: >Weekender</option>
    ]
