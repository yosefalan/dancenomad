    ...
    <div className="formContainer">
      ...
      className="form">
        ...
        <select
          ...
          <option value="1">Afro Cuban </option>
          <option value="1">Bachata </option>
          <option value="1">Ballroom</option>
          <option value="1">Blues</option>
          <option value="1">Brazilian Zouk</option>
          <option value="1">Breakdance</option>
          <option value="1">Casino Rueda</option>
          <option value="1">Cha Cha</option>
          <option value="1">East Coast Swing </option>
