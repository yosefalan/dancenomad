...
function CreateEventForm () {
  ...
  const handleSubmit = (e) => {
    ...
    const types_options = [
    { value: "1">Class</option>
    { value: "2">Competition</option>
    { value: "3">Congress</option>
    { value: "4">Dance Cruise</option>
    { value: "5">Flash Mob</option>
    { value: "6">Marathon</option>
    { value: "7">Nightclub Event</option>
    { value: "8">Retreat</option>
    { value: "9">Social</option>
    { value: "10">Weekender</option>
    ]
